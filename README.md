...
A terminal music player for local libraries, Winamp inspired.
...
[![star/amp playing an album, with the analyzer, playlist and album art](docs/screenshot.png)](docs/screenshot.png)
...
**From source** needs a Rust toolchain (1.86 or newer), `libclang` for

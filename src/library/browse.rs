            ...
            Ok(Raw {
                item: QueueItem {
                    ...
                    rg: crate::audio::dsp::gain::ReplayGain {
                        track_gain_db: r.get::<_, Option<f64>>(18)?.map(|v| v as f32),
                        track_peak: r.get::<_, Option<f64>>(19)?.map(|v| v as f32),
                        album_gain_db: r.get::<_, Option<f64>>(20)?.map(|v| v as f32),
                        album_peak: r.get::<_, Option<f64>>(21)?.map(|v| v as f32),
                    },
                    unplayable: false,
                },
                span: Span {

...
impl Field {
    ...
    pub fn parse(s: &str) -> Option<Field> {
        ...
        Some(match s.to_ascii_lowercase().as_str() {
            ...
            "distortion" | "distorted" | "guitar" => Distortion,
            "analyzed" | "analysed" | "sonic" => Analyzed,
            _ => return None,
        })
    }
    ...
    /// Does this field live in the rebuildable local sonic index?
    pub fn needs_sonic(self) -> bool {
        use Field::*;
        matches!(
            self,
            Energy | Tempo | Brightness | Dynamics | Distortion | Analyzed
        )
    }
}

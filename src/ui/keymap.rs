...
pub const MOUSE: &[MouseHelp] = &[
    ...
    MouseHelp {
        gesture: "click `sorting`",
        label: "order the playlist",
        group: "playlist",
    },
    MouseHelp {
        gesture: "click `gravity`",
        label: "create a related list",
        group: "playlist",
    },
    MouseHelp {
    ...
    MouseHelp {
        gesture: "click footer status",
        label: "toggle its mode",
        group: "player",
    },
    MouseHelp {
    ...
    MouseHelp {
        gesture: "click a filter",
        label: "select it",
        group: "equalizer",
    },
    MouseHelp {
        gesture: "wheel over the panel",
        label: "previous / next filter",
        group: "equalizer",
    },
    MouseHelp {
        gesture: "click cover",
    ...
    MouseHelp {
        gesture: "click < / >",
        label: "previous / next art",
        group: "album",
    },
    MouseHelp {
        gesture: "click title / artist",
        label: "open music database",
        group: "album",
    },
    MouseHelp {
...
pub const BINDINGS: &[Binding] = &[
    ...
    Binding {
        action: Action::OpenCover,
        keys: "o / enter",
        label: "open full image",
        group: "album",
    },
    Binding {
        action: Action::PrevCover,
        keys: "left",
        label: "previous image",
        group: "album",
    },
    Binding {
        action: Action::NextCover,
        keys: "right",
        label: "next image",
        group: "album",
    },
    ...
    Binding {
        ...
        keys: "left/right",
        label: "filter gain, 1 dB",
        group: "equalizer",
    },
    Binding {
        action: Action::EqGainUpBig,
        keys: "shift+left/right",
        label: "filter gain, 10 dB",
        group: "equalizer",
    },
    Binding {
        action: Action::EqToggleStage,
        keys: "enter",
        label: "bypass the filter",
        group: "equalizer",
    },
    Binding {
        action: Action::EqAddStage,
        keys: "a",
        label: "add a filter",
        group: "equalizer",
    },
    Binding {
        action: Action::EqRemoveStage,
        keys: "d",
        label: "remove it",
        group: "equalizer",
    },
...
fn album(k: KeyEvent) -> Option<Action> {
    ...
    Some(match k.code {
        ...
        Char('o') | Enter => Action::OpenCover,
        Left => Action::PrevCover,
        Right => Action::NextCover,
        _ => return None,
    })
}
...
mod tests {
    ...
    #[test]
    fn vim_list_ends_leave_plain_g_for_the_two_key_dispatcher() {
        assert_eq!(resolve(key('g')), None);
        assert_eq!(resolve(key('G')), Some(Action::End));
        assert_eq!(
            resolve(KeyEvent::new(KeyCode::Home, KeyModifiers::NONE)),
            Some(Action::Home)
        );
    }

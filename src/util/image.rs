...
//!
//! Every image staramp decodes came from outside it: embedded in a tag, sitting
//! in an album folder, inside a downloaded skin, or fetched from the Cover Art
//! Archive. The `image` crate's own defaults allow any width and height and cap
